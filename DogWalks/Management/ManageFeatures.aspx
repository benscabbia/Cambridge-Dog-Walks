...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentChild" runat="server">
  <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="FeatureID" EmptyDataText="No Features to display" AllowPaging="True" PageSize="50" AllowSorting="True" CellPadding="4" ForeColor="#333333">
